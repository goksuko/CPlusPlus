...
/*                                                   +#+                      */
/*   Created: 2025/03/20 12:21:20 by akaya-oz      #+#    #+#                 */
/*   Updated: 2025/04/15 12:48:47 by akaya-oz      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << BOLDBLUE  << amount << " POINTS OF DAMAGE TO " << _name << RESET << std::endl;
...
{
	std::cout << BOLDGREEN  << amount << " POINTS OF REPAIR FOR " << _name << RESET << std::endl;
	if (amount <= 0 || amount > std::numeric_limits<unsigned int>::max())
	{
